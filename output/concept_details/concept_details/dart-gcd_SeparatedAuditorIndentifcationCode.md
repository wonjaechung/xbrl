# Concept: Separated Auditor indentification code

## Bilingual Labels
- **EN**: Separated Auditor indentification code
- **KO**: 개별 감사인고유번호

- **ID**: dart-gcd:SeparatedAuditorIndentifcationCode
...
Bilingual Labels
 EN: Separated Auditor indentification code
 KO: 개별 감사인고유번호
 ID: dartgcd:SeparatedAuditorIndentifcationCode
Reported Numerical Facts
Context (Labels): Period [axis]: Period covered by last fiscal year [member]
