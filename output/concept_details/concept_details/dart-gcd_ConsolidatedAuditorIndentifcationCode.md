# Concept: Consolidated Auditor indentification code

## Bilingual Labels
- **EN**: Consolidated Auditor indentification code
- **KO**: 연결 감사인고유번호

- **ID**: dart-gcd:ConsolidatedAuditorIndentifcationCode
...
Bilingual Labels
 EN: Consolidated Auditor indentification code
 KO: 연결 감사인고유번호
 ID: dartgcd:ConsolidatedAuditorIndentifcationCode
Reported Numerical Facts
Context (Labels): Period [axis]: Period covered by last fiscal year [member]
